...
### In case of "one node produced an error: index 0 outside bounds" error:
### 1. install.packages("devtools")
### 2. devtools::install_github("csgillespie/poweRlaw")
...
tmpSCL<-list(#read.csv(paste(data_path,"/temporal_cumulative/Pilots_cumulative_median.csv", sep=""),header=T,sep=","),
               read.csv(paste(data_path,"/temporal_cumulative/Pilots_cumulative_phases.csv", sep=""),header=T,sep=","))
