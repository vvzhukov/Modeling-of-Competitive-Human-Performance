...
# SCholars generations split 1
BIO_s1996 <- subset(BIO_raw, y1996 != 0 | y1997 != 0 | y1998 != 0)[,22]
...
BIO_s2002 <- subset(BIO_raw, ((y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0 & 
                                  y1999 == 0 & 
                                  y2000 == 0 & 
...
a_bio <- list(as.integer(BIO_s1996), 
          as.integer(BIO_s1999), 
          as.integer(BIO_s2002))


b_bio <- data.frame(lapply(a_bio, "length<-", max(lengths(a_bio))))
colnames(b_bio) <- c("s1996", "s1999", "s2002")
...
# SCholars generations split 2
BIO_s1996 <- subset(BIO_raw, y1996 != 0 | y1997 != 0 | y1998 != 0 | y1999 != 0)[,22]


BIO_s2000 <- subset(BIO_raw, (y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0 & 
                                  y1999 == 0) & 
                        (y2000 != 0 |
...
a_bio <- list(as.integer(BIO_s1996), 
              as.integer(BIO_s2000), 
              as.integer(BIO_s2004))


b_bio2 <- data.frame(lapply(a_bio, "length<-", max(lengths(a_bio))))
colnames(b_bio2) <- c("s1996", "s2000", "s2004")
...
# SCholars generations split 3
BIO_s1999 <- subset(BIO_raw, (y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0) & (y1999 != 0 | y2000 != 0 | y2001 != 0 | y2002 != 0 | y2003 != 0))[,22]

BIO_2004 <- subset(BIO_raw, (y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0 & 
                                  y1999 == 0 & 
                                 y2000 == 0 & 
...
b_bio3 <- data.frame(lapply(a_bio, "length<-", max(lengths(a_bio))))
colnames(b_bio3) <- c("s1999", "s2004", "s2009")
...
VarNamesL<-list(c("s1996", "s1999", "s2002"),
                c("s1996", "s2000", "s2004"),
                c("s1999", "s2004", "s2009")
                )
