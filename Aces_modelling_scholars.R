...
# Pilots generations
BIO_s1996v2 <- subset(BIO_raw, y1996 != 0)[,22]
CS_s1996v2 <- subset(CS_raw, y1996 != 0)[,22]

BIO_s1996 <- subset(BIO_raw, y1996 != 0 | y1997 != 0 | y1998 != 0 | 
                            y1999 != 0 | y2000 != 0 | y2001 != 0 | y2002 != 0)[,22]

CS_s1996 <- subset(CS_raw, y1996 != 0 | y1997 != 0 | y1998 != 0 | 
                        y1999 != 0 | y2000 != 0 | y2001 != 0 | y2002 != 0)[,22]

BIO_s2003 <- subset(BIO_raw, (y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0 & 
                                  y1999 == 0 & 
                                  y2000 == 0 & 
...
CS_s2003 <- subset(CS_raw, (y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0 & 
                                  y1999 == 0 & 
                                  y2000 == 0 & 
...
BIO_s2010 <- subset(BIO_raw, ((y1996 == 0 & 
                                  y1997 == 0 & 
                                  y1998 == 0 & 
                                  y1999 == 0 & 
                                  y2000 == 0 & 
...
CS_s2010 <- subset(CS_raw, ((y1996 == 0 & 
                                   y1997 == 0 & 
                                   y1998 == 0 & 
                                   y1999 == 0 & 
                                   y2000 == 0 & 
...
a_bio <- list(as.integer(BIO_s1996v2), 
          as.integer(BIO_s1996), 
          as.integer(BIO_s2003), 
          as.integer(BIO_s2010))

a_cs <- list(as.integer(CS_s1996v2), 
            as.integer(CS_s1996), 
            as.integer(CS_s2003), 
            as.integer(CS_s2010))

b_bio <- data.frame(lapply(a_bio, "length<-", max(lengths(a_bio))))
colnames(b_bio) <- c("s1996v2", "s1996", "s2003", "s2010")

b_cs <- data.frame(lapply(a_cs, "length<-", max(lengths(a_cs))))
colnames(b_cs) <- c("s1996v2", "s1996", "s2003", "s2010")
...
VarNamesL<-list(c("s1996v2", "s1996", "s2003", "s2010"),
                c("s1996v2", "s1996", "s2003", "s2010")
                )
