...
### Olympic Medal Scores for FRA Athletes
...
tmpOMS_USA<-read.csv("./Athletes/OlympicMedalsScores_FRA_year_cumulative_full.csv",header=T,sep=",")

#tmpOMS_USA<-read.csv("OlympicMedalsScores_FRA_year_cumulative_trunc.csv",header=T,sep=",")
#tmpOMS_USA<-read.csv("OlympicMedalsScores_GBR_year_cumulative_full.csv",header=T,sep=",")
