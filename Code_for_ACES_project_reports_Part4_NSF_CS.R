...
### i.e. chronological evaluation of the NSF CS grants
...
NSF_1998<-sort(NSFallnz[,G_time[1]])	### NSF grants until 1998
NSF_2001<-sort(NSFallnz[,G_time[2]])	### NSF grants until 2001
NSF_2004<-sort(NSFallnz[,G_time[3]])	### NSF grants until 2004
NSF_2007<-sort(NSFallnz[,G_time[4]])	### NSF grants until 2007
NSF_2010<-sort(NSFallnz[,G_time[5]])	### NSF grants until 2010
NSF_2013<-sort(NSFallnz[,G_time[6]])	### NSF grants until 2013
NSF_2016<-sort(NSFallnz[,G_time[7]])	### NSF grants until 2016

Data<-list(NSF_1998, NSF_2001, NSF_2004, NSF_2007, NSF_2010, NSF_2013, NSF_2016)
VarNames<-c("NSF_1998", "NSF_2001", "NSF_2004", "NSF_2007", "NSF_2010", "NSF_2013", "NSF_2016")
...
#pdf(file="C:\\Users\\PT_office\\Desktop\\Aces_project\\Plots_evolution\\NSF_chronological_evolution.pdf")
...
title("Histograms of the NSF Grants data sets",outer=T,cex.main=2,col.main="blue",line=-0.5)
