...
tmpSCL<-list(read.csv(paste(data_path,"/temporal_cumulative/Scholars_cumulative_CS.csv", sep=""),header=T,sep=","),
               read.csv(paste(data_path,"/temporal_cumulative/Scholars_cumulative_BIO.csv", sep=""),header=T,sep=","))
...
setwd(paste(data_path, "/scripts_results/CUMULATIVE/", datasets[i], sep=""))
