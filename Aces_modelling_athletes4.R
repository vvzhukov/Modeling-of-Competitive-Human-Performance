...
disc_1 <- read.csv(file = paste(path2,"/Athletes_breakdown_score_M200_Freestyle.csv", sep=''))
disc_2 <- read.csv(file = paste(path2,"/Athletes_breakdown_score_W100_Freestyle.csv", sep=''))

athletes_US_sw <- disc_1
...
disc_11 <- US_total_sw
disc_12 <- US_total_sw2


athletes_US_sw <- disc_2
# up to 1960 and from 1964 till today
athletes_US_sw$started_at <- ifelse(rowSums(athletes_US_sw[,c(6:28)]) != 0, "Up to 1960", "From 1964")
...
disc_21 <- US_total_sw
disc_22 <- US_total_sw2

datasets <- c(
              "USA_SWIMMERS_M200_2_GR",
              #"USA_SWIMMERS_M200_4_GR",
              "USA_SWIMMERS_W100_2_GR"
              #"USA_SWIMMERS_W100_4_GR"
              )
