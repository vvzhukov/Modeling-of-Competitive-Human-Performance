...
tmpSCL<-list(read.csv(paste(data_path,"/temporal_cumulative/Scholars_CS_cumulative.csv", sep=""),header=T,sep=","),
               read.csv(paste(data_path,"/temporal_cumulative/Scholars_BIO_cumulative.csv", sep=""),header=T,sep=","))
